...
bool HelloWorld::init()
{
    ...
    //demo name
    {
        CCLabelTTF* pLabel = CCLabelTTF::create("3D ToolKit for cocos2d-x - Test 3 - shadow map", "Arial", 45);
    ...
    // author info
    {
        CCLabelTTF* pLabel = CCLabelTTF::create("by Yang Chao (wantnon) 2014-12-8", "Arial", 25);
        pLabel->setPosition(ccp(origin.x + visibleSize.width/2,
